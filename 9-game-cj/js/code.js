...
function preloadMenu(){
    ...
    game.load.image('startButton', '9-game-cj/images/startButton.png');
    game.load.image('howtoplayButton', '9-game-cj/images/howtoplay.png');
    game.load.image('logoGame', '9-game-cj/images/logoGame.png');
    game.load.image('creditButton', '9-game-cj/images/creditButton.png');
    game.load.image('reportButton', '9-game-cj/images/reportButton.png');
    game.load.image('scoreBoardButton', '9-game-cj/images/scoreBoardButton.png');
}
function preload() {
    game.load.image('bullet', '9-game-cj/images/bullet.png');
    game.load.image('ship', '9-game-cj/images/wip.png');
    game.load.image('enemy_ship', '9-game-cj/images/enemyship.png');
    game.load.image('background3', '9-game-cj/images/BG-galaxy.png');
    game.load.image('background1', '9-game-cj/images/firstState.png');
    game.load.image('background2', '9-game-cj/images/secondState.png');
    ...
    game.load.spritesheet('sharkSeal', '9-game-cj/images/shark.png');
    game.load.spritesheet('spacebarBlock', '9-game-cj/images/dontpush.png');
    game.load.spritesheet('numberText', '9-game-cj/images/numberText.png', 744 / 11, 78, 11);
    game.load.spritesheet('restartBtn', '9-game-cj/images/restartBtn.png');
    game.load.spritesheet('smoke', '9-game-cj/images/smoke.png',200,350,2);

    /////metarial/////
    game.load.spritesheet('airship', '9-game-cj/images/airship2.png');
    game.load.spritesheet('balloon', '9-game-cj/images/balloon.png');
    game.load.spritesheet('airplane', '9-game-cj/images/airplane2.png');
    game.load.spritesheet('earth', '9-game-cj/images/earth.png');
    game.load.spritesheet('sattellite', '9-game-cj/images/sattellite.png');
    game.load.spritesheet('saturn', '9-game-cj/images/saturn.png');
    game.load.spritesheet('sharkAlien', '9-game-cj/images/sharkalien.png');
    game.load.spritesheet('shark', '9-game-cj/images/shark2.png', 50, 50);
    game.load.spritesheet('shipAndCannon', '9-game-cj/images/cannon.png');
    game.load.spritesheet('clound1', '9-game-cj/images/clound.png');
    game.load.spritesheet('clound2', '9-game-cj/images/clound2.png');
    game.load.spritesheet('clound3', '9-game-cj/images/clound3.png');
    game.load.spritesheet('mountain', '9-game-cj/images/mountain.png');
    game.load.spritesheet('sun', '9-game-cj/images/sun.png');
    ////sound////
    ...
    game.load.audio('menu','9-game-cj/sound/Menu.mp3');
